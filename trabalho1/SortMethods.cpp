...
void SortMethods::quickSort2(T *v, int beg, int end, FuncType func)
{
    ...
    else
    {
        ...
        int pos = SortMethods::particiona(v, beg, end, pivoAleatorio, func);
        SortMethods::quickSort2(v, beg, pos, func);
        SortMethods::quickSort2(v, pos + 1, end, func);
    }
}
template <class FuncType, class T>
int SortMethods::quickSort(T *v, int n, FuncType func)
{
    SortMethods::quickSort2(v, 0, n, func);
    return 0;
}
