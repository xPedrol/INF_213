...
int buscaBin(int *array, int begin, int end, int chave, int maior = -1)
{
	if (begin > end)
		return maior;
	...
	{
		maior = meio;
		return buscaBin(array, begin, meio - 1, chave, maior);
	}
	return buscaBin(array, meio + 1, end, chave, maior);
}
